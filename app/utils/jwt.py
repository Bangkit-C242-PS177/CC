...
def add_to_blocklist(jti):
    """
    Menambahkan JTI ke dalam blocklist untuk mencabut token.
    
    Args:
        jti (str): JWT ID yang akan ditambahkan ke blocklist.
    """
    BLOCKLIST.add(jti)

def is_token_revoked(jti):
    """
    Memeriksa apakah token telah dicabut.
    
    Args:
        jti (str): JWT ID yang akan diperiksa.

    Returns:
        bool: True jika token telah dicabut, False jika tidak.
    """
